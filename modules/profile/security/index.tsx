...
export default function SecurityPages({ access_token, logged }: any) {
  ...
  return (
    <>
      {successMessage && (
        <>
          <div className="innerContainer-0-2-2">
            <div className="root-0-2-141 lightTheme-0-2-142">
              <div className="textArea-0-2-149">
                <div className="checkButton-0-2-147">
                  <svg
                    className="fill-0-2-153"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
                ...
                <div className="info-0-2-150">success message</div>
              </div>
              <div
              ...
              >
                <svg
                  className="fill-0-2-153 closeIcon-0-2-146"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  fill="none"
