...
const ProfileSecurityPages: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t("SECURITY__PAGE__HELMET")}</title>
      </Helmet>
        ...
        <div className="marginOnMobile-0-2-102 root-0-2-100">
          ...
          <div className="body-0-2-101">
            <section className="root___0__2__183">
              <h2 className="h2-0-2-184">{t("SECURITY__NAV")}</h2>
                  ...
                  <div className="root-0-2-119">
                    ...
                    {errors.currentPassword && (
                      <div className="invalidMessage-0-2-132">
                        {t("CURRENT__PASSWORD__REQUIRED")}
                      </div>
                    )}
                    {inCorrectPassword && (
                      <div className="invalidMessage-0-2-132">
                        {t("INCORRECT__CURRENT__PASSWORD")}
                      </div>
                    )}
                  </div>
                  <div className="root-0-2-119">
                    ...
                    {errors.repeatPassword && (
                      <div className="invalidMessage-0-2-132">
                        {errors.repeatPassword?.message ==
                          ...
                          t("REPEAT__PASSWORD__REQUIRED")}
                        {errors.repeatPassword?.message ==
                          "Passwords do not match" &&
                          t("PASSWORD__MATCH__REQUIRED")}
                      </div>
                    )}
                  </div>
                  {mutation.isLoading ? (
