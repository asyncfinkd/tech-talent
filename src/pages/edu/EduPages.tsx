        ...
        <div className="root-0-2-233">
          <div className="root-0-2-102">
            <div className="marginOnMobile-0-2-134">
              <form>
                <div className="header-0-2-103">
                  <h1 className="h1-0-2-104">
                    Find an <span>educational facility </span>that you trust
                  </h1>
                  <div className="buttonGroup-0-2-115"></div>
                </div>
                <div className="topLine-0-2-112"></div>
                <div className="mobileFilter-0-2-122">
                  <button className="root-0-2-46 primaryMobileFilter-0-2-123 animation-0-2-47 weightMedium-0-2-61 sizeSm-0-2-50 variantSecondary-0-2-55">
                    Field
                    <svg
                      className="fill-0-2-36 caret-0-2-127"
                      width="10"
                      height="6"
                      viewBox="0 0 10 6"
                      fill="none"
                  ...
                  <button className="root-0-2-46 secondaryMobileFilter-0-2-124 animation-0-2-47 weightMedium-0-2-61 sizeSm-0-2-50 variantSecondary-0-2-55">
                    Category
                    <svg
                      className="fill-0-2-36 caret-0-2-127"
                      width="10"
                  ...
                  <button className="root-0-2-46 detailMobileFilter-0-2-125 animation-0-2-47 weightMedium-0-2-61 sizeSm-0-2-50 variantSecondary-0-2-55">
                    <svg
                      className="fill-0-2-36 detailMobileFilterIcon-0-2-126"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <div className="searchContainer-0-2-108">
                  <div className="iconInputPair-0-2-107">
                    <div className="iconContainer-0-2-109">
                      <svg
                        className="fill-0-2-36 searchIcon-0-2-110"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        fill="none"
            ...
            <div className="bottomLine-0-2-113"></div>
          </div>
          <div className="marginOnMobile-0-2-134">
